...
public class DeleteUserCommandHandler(INotificationContext notification, IUnitOfWork unitOfWork, IEventPublisher eventPublisher) : IRequestHandler<DeleteUserCommand, Unit?>
{
